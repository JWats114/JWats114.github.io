...
addCourseBtn.addEventListener("click", () => {
    ...
    wrapper.innerHTML = `
        ...
        <input type="text" placeholder="Department" class="dept" name="dept[]"><br><br>
        <label>Class Number</label><br>
        <input type="text" placeholder="Number" class="num" name="num[]"><br><br>
        <label>Class Title</label><br>
        <input type="text" placeholder="Name" class="name" name="name[]"><br><br>
        <label>Reason for taking</label><br>
        <input type="text" placeholder="Reason" class="reason" name="reason[]"><br><br>
